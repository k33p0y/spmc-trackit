...
class EventTicketViewSet(viewsets.ModelViewSet):    
   ...
   def get_queryset(self):
      ...
      if search: qs = qs.filter(Q(ticket__requested_by__first_name__icontains=search) | Q(ticket__requested_by__last_name__icontains=search) | Q(ticket__ticket_no__icontains=search))
